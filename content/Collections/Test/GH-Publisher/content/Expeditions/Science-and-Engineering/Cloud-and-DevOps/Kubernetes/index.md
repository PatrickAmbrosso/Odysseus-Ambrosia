...
2. **Container Runtime**
	...
	- Any container runtimes that follow the OCI spec can be used as the container runtime. Some of the most popular choices include *[containerd](containerd.md)* and *[Docker](../Docker/index.md#.md#)*. 
3. **Kube proxy**
