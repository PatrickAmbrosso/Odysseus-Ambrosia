...
To fetch an existing remote repository into a local environment for development.
...
> 
> That being said, in Windows [PowerShell](../../Programming-and-Scripting/PowerShell/index.md) is the preferred Shell of choice. All of these commands work on PowerShell as well. Just being mindful on the slash type (`/`or`\`) is required nonetheless.
